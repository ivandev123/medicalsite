  ...
  <div class="informational-articles">
    ...
    <Carousel ref="carousel" :items-to-show="getCountSlides">
      <Slide v-for="article in 5" :key="article.id">
        <div class="informational-articles__item">
          <img src="@/assets/images/info-article.jpg" alt="article image" class="informational-articles__image">
          <div class="informational-articles__info informational-articles__info_mt-12">
            <div class="informational-articles__date">31.07.2023</div>
            <div class="informational-articles__tag">
              <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="18px" height="15px" viewBox="0 0 1280.000000 662.000000">
                <g transform="translate(0.000000,662.000000) scale(0.100000,-0.100000)" fill="#262626" stroke="none">
          ...
          <div class="informational-articles__title informational-articles__title_mt-14">
