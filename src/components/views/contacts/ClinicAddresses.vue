<template>
  <div class="clinic-addresses">
    ...
    <div class="clinic-addresses__content clinic-addresses__content_mt-20">
  ...
  methods: {
    async loadMap() {
      ...
      this.addresses.forEach((address, idx) => {
        ...
        content.id = `yandex-map-section-${address.id}`;
        ...
        content.innerHTML = `
            ...
            <div class="yandex-map-prompt yandex-map-prompt-${idx + 1} d-none">
                ...
                <div class="yandex-map-prompt__content">
                    <span class="yandex-map-prompt__street">${address.address.street} ул., ${address.address.building}, ${address.address.city}</span>
                    <span class="yandex-map-prompt__floor">этаж ${address.address.floor}</span>
                    <span class="yandex-map-prompt__phone yandex-map-prompt__phone_mt-4">${address.phone}</span>
                </div>
            </div>`;
